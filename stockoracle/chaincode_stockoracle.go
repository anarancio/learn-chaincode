...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
  ...
  } else if function == "new_price" {
    return t.new_price(stub, args)
  }
  return nil, errors.New("Received unknown function invocation: " + function)
}

func (t *SimpleChaincode) new_price(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
  fmt.Println("new_price called")
  if len(args) != 1 {
  ...
  bytes, err = stub.GetState("stock_oracle_listeners")
...
func (t *SimpleChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
  ...
  if function == "get_price" {
    return t.get_price(stub)
...
func (t *SimpleChaincode) get_price(stub shim.ChaincodeStubInterface) ([]byte, error) {
  fmt.Println("get_price called")
	bytes, err := stub.GetState("stock_price")
	fmt.Println(bytes)
